...
public class DbQueueStat {
    ...
    /**
     *  The number of records in the database. If Db.DB_FAST_STAT was specified
     *  the count will be the last saved value unless it has never been
     *  calculated, in which case it will be 0. Returned if Db.DB_FAST_STAT is
     *  set.
     *</ul>
     *
     */
    ...
    /**
     *  Underlying database extent size, in pages. Returned if Db.DB_FAST_STAT
     *  is set.
     *</ul>
     *
     */
    ...
    /**
     *  The padding byte value for the records. Returned if Db.DB_FAST_STAT is
     *  set.
     *</ul>
     *
     */
    ...
    /**
     *  First undeleted record in the database. Returned if Db.DB_FAST_STAT is
     *  set.
     *</ul>
     *
     */
