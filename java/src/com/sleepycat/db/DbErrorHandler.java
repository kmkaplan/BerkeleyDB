 ...
 *
 *  $Id: DbErrorHandler.java,v 11.13 2003/11/10 16:23:02 bostic Exp $
 */
...
public interface DbErrorHandler {
     ...
     *  DbErrorHandler interface with additional error information. It is up to
     *  this interface to display the error message in an appropriate manner.
     *  </p> <p>
     *
     *  </p>
     *
     *@param  errpfx  the prefix string (as previously set by {@link
     *      com.sleepycat.db.Db#setErrorPrefix Db.setErrorPrefix} or {@link
